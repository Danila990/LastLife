        ...
        private void EnsureAngleParameters(int childCount)
        {
            ...
            case Direction.Clockwise:
                if (AngleConstraint == ConstraintMode.Interval)
                {
                    ...
                    mAngleRange = intervalCount * mAngleDelta;
                }
                else
                {
                    ...
                    if (intervalCount > 0)
                    {
                        mAngleDelta = mAngleRange / intervalCount;
                    }
                    else
                    {
                        mAngleDelta = 0;
        ...
        private void EnsureRadiusParameters(int childCount)
        {
            ...
            case Direction.Clockwise:
                if (RadiusConstraint == ConstraintMode.Interval)
                {
                    ...
                    mRadiusRange = intervalCount * mRadiusDelta;
                }
                else
                {
                    ...
                    if (intervalCount > 0)
                    {
                        mRadiusDelta = mRadiusRange / intervalCount;
                    }
                    else
                    {
                        mRadiusDelta = 0;
