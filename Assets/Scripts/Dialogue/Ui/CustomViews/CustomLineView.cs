...
{
    public interface ICustomDialogueView
    {
        public DialogueUiController DialogueUiController { get; set; }
    }
    
	public class CustomLineView : DialogueViewBase, ICustomDialogueView
	{
		/// <summary>
        ...
        /// </remarks>
        [SerializeField] public GameObject characterNameContainer = null;
        ...
        [SerializeField, ShowIf("useTypewriterEffect")] public UnityEngine.Events.UnityEvent onCharacterTyped;
        ...
        /// </remarks>
        /// <seealso cref="useTypewriterEffect"/>
        [SerializeField, ShowIf("useTypewriterEffect")] public UnityEngine.Events.UnityEvent onPauseStarted;
        /// <summary>
        ...
        /// </remarks>
        /// <seealso cref="useTypewriterEffect"/>
        [SerializeField, ShowIf("useTypewriterEffect")] public UnityEngine.Events.UnityEvent onPauseEnded;
        ...
        /// </summary>
        /// <seealso cref="useTypewriterEffect"/>
        [SerializeField, ShowIf("useTypewriterEffect")]
        [Min(0)]
        ...
        /// </summary>
        [SerializeField, ShowIf("autoAdvance")]
        [Min(0)]
        ...
        /// displaying.
        /// </summary>
        private LocalizedLine _currentLine = null;

        /// <summary>
        /// A stop token that is used to interrupt the current animation.
        /// </summary>
        private readonly Effects.CoroutineInterruptToken _currentStopToken = new Effects.CoroutineInterruptToken();
        public DialogueUiController DialogueUiController { get; set; }
        ...
        private IEnumerator DismissLineInternal(Action onDismissalComplete)
        {
            ...
            if (useFadeEffect)
            {
                yield return StartCoroutine(Effects.FadeAlpha(canvasGroup, 1, 0, fadeOutTime, _currentStopToken));
        ...
        public override void RunLine(LocalizedLine dialogueLine, Action onDialogueLineFinished)
        {
            ...
            if (dialogueLine.Text.TryGetAttributeWithName("Header", out var header))
            {
        ...
        private async UniTaskVoid DelayEnable()
        {
        ...
        private IEnumerator RunLineInternal(LocalizedLine dialogueLine, Action onDialogueLineFinished)
        {
            ...
            IEnumerator PresentLine()
            {
                ...
                lineText.text = palette != null ? LineView.PaletteMarkedUpText(text, palette) : LineView.AddLineBreaks(text);

                // If we're using the typewriter effect, hide all of the
                // text before we begin any possible fade (so we don't fade
                // in on visible text).
                lineText.maxVisibleCharacters = useTypewriterEffect ? 0 :
                ...
                if (useFadeEffect)
                {
                    yield return StartCoroutine(Effects.FadeAlpha(canvasGroup, 0, 1, fadeInTime, _currentStopToken));
        ...
        private void CheckBackTag()
        {
            BackButton.gameObject.SetActive(DialogueUiController.CurrentNodeTags.Contains("#CanBack"));
        }
