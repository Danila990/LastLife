...
#region PublicMethods
		...
		public virtual void OnLoseBalance() {return;}
		public virtual void OnRegainBalance() {return;}
...
#region ReuseableMethods
		...
		{
			if (!Fsm.Player.MechEntityContext)
				return;
			
			Fsm.Player.MechEntityContext.CharacterAnimator.Animator.SetBool(animationHash, true);
			return;
		...
		protected void StopAnimation(int animationHash)
		{
			if (Fsm.Player.MechEntityContext)
			{
				Fsm.Player.MechEntityContext.CharacterAnimator.Animator.SetBool(animationHash, false);
			}
		}
