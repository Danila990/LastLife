...
{
    public class MechJumpingState : MechAirborneState
    {
        private IDisposable _timer;
        
        private bool _canStartFalling;

        public MechJumpingState(MechMovementStateMachine playerMovementStateMachine) : base(playerMovementStateMachine)
        {
        }
