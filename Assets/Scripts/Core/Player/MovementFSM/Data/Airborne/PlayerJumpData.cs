...
namespace Core.Player.MovementFSM.Data.Airborne
{
    ...
    public class PlayerJumpData
    {
        ...
        [field: SerializeField] [field: Range(0f, 5f)] public float RotateSpeedOnJump { get; private set; } = .25f;
        [field: SerializeField] [field: Range(0f, 5f)] public float RotateSpeedOnFall { get; private set; } = .25f;
